...
var createSets = function(data, userID1, userID2) {
  
}

var findJaccordIndex = function (setA, setB) {
  var setIntersection = intersection(setA, setB);
  var setUnion = union(setA, setB);

  return setIntersection.length / setUnion.length;
}

var getRecommendedUsers = function(req, res) {
  var setA = [];
  var setB;
  var jaccordIndex = [];
  var len;
